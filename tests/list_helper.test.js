...
describe('favorite blog', () => {
  ...
  test('when list has no blogs favorite blog is', () => {
    const result = listHelper.favoriteBlog(listWithZeroBlog)
    expect(result).toEqual(listWithZeroBlog)
  })

  test('when list has multiple blogs favorite blog is', () => {
    const result = listHelper.favoriteBlog(listWithMultipleBlog)
    expect(result).toEqual(resultWithMultipleBlog)
  })
})